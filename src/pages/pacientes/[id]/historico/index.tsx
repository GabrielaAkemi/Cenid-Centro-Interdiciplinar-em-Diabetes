...
interface HistoryItem {
  ...
  finalizada: boolean; // Campo de status
}
...
export default function Consultas() {
  ...
  const fetchHistories = async (especialidade: string) => {
    ...
    const cleanData: HistoryItem[] = data.map((consulta: any) => {
      // Garante que 'consulta.finalizada' seja o nome do campo da sua API
      const statusFinalizada = consulta.finalizada || false;
      ...
      return {
        ...
        data: consulta.data_consulta
          ...
          : "N/A",
        especialidade,
        finalizada: statusFinalizada, // Salva o status
      };
    });
  ...
  const renderForm = () => {
    ...
    switch (selectedForm) {
      ...
      case "consultaedfisica":
        return (
          <EdFisicaForm patientData={paciente} initialData={selectedHistoryData} />
        );
