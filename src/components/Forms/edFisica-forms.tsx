  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100 font-sans p-6 text-gray-800">
      <div className="max-w-4xl mx-auto w-full bg-white shadow-xl rounded-xl p-8 space-y-6">
        <h1 className="text-3xl font-bold text-center text-blue-900">Avaliação de Educação Física</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 text-blue-900">
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-blue-900 border-b-2 border-blue-200 pb-2">Dados do Paciente</h2>
            <p className="text-gray-700 text-sm">A avaliação da Educação Física completa deverá ser realizada com intervalo mínimo de 6 meses e máximo de 12 meses. Porém neste intervalo de tempo a avaliação poderá ser complementada com orientações de sobre exercício físico.</p>
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-blue-900 border-b-2 border-blue-200 pb-2">Questionário de Nível de Atividade Física (NAF)</h2>
                      ...
                      <tr key={day.key}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <input
                            ...
                            className="w-full rounded-lg p-2 border border-gray-300 focus:ring focus:ring-blue-200"
                          />
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <input
            ...
            <div className="flex flex-col">
              ...
              <textarea
                ...
                className="rounded-lg p-3 border border-gray-300 focus:ring focus:ring-blue-200 min-h-[100px]"
              ></textarea>
            </div>
          </div>

          <div className="space-y-4">
            <h2 className="text-xl font-bold text-blue-900 border-b-2 border-blue-200 pb-2">Avaliação do Condicionamento Físico</h2>
              ...
              <table className="min-w-full divide-y divide-gray-200 rounded-lg shadow-sm overflow-hidden">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  <tr>
                    ...
                    <td className="px-6 py-4"><input type="number" step="0.1" value={formData.forcaMaoDominante.medida1} onChange={(e) => handleStrengthChange("forcaMaoDominante", "medida1", e.target.value)} className="w-full rounded-lg p-2 border border-gray-300" /></td>
                    <td className="px-6 py-4"><input type="number" step="0.1" value={formData.forcaMaoDominante.medida2} onChange={(e) => handleStrengthChange("forcaMaoDominante", "medida2", e.target.value)} className="w-full rounded-lg p-2 border border-gray-300" /></td>
                    <td className="px-6 py-4"><input type="number" step="0.1" value={formData.forcaMaoDominante.medida3} onChange={(e) => handleStrengthChange("forcaMaoDominante", "medida3", e.target.value)} className="w-full rounded-lg p-2 border border-gray-300" /></td>
                  ...
                  <tr>
                    ...
                    <td className="px-6 py-4"><input type="number" step="0.1" value={formData.forcaMaoNaoDominante.medida1} onChange={(e) => handleStrengthChange("forcaMaoNaoDominante", "medida1", e.target.value)} className="w-full rounded-lg p-2 border border-gray-300" /></td>
                    <td className="px-6 py-4"><input type="number" step="0.1" value={formData.forcaMaoNaoDominante.medida2} onChange={(e) => handleStrengthChange("forcaMaoNaoDominante", "medida2", e.target.value)} className="w-full rounded-lg p-2 border border-gray-300" /></td>
                    <td className="px-6 py-4"><input type="number" step="0.1" value={formData.forcaMaoNaoDominante.medida3} onChange={(e) => handleStrengthChange("forcaMaoNaoDominante", "medida3", e.target.value)} className="w-full rounded-lg p-2 border border-gray-300" /></td>
                  ...
                  <tr>
                    ...
                    <td className="px-6 py-4"><input type="number" step="0.1" value={formData.forcaLombar.medida1} onChange={(e) => handleStrengthChange("forcaLombar", "medida1", e.target.value)} className="w-full rounded-lg p-2 border border-gray-300" /></td>
                    <td className="px-6 py-4"><input type="number" step="0.1" value={formData.forcaLombar.medida2} onChange={(e) => handleStrengthChange("forcaLombar", "medida2", e.target.value)} className="w-full rounded-lg p-2 border border-gray-300" /></td>
                    <td className="px-6 py-4"><input type="number" step="0.1" value={formData.forcaLombar.medida3} onChange={(e) => handleStrengthChange("forcaLombar", "medida3", e.target.value)} className="w-full rounded-lg p-2 border border-gray-300" /></td>
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-blue-900 border-b-2 border-blue-200 pb-2">Prescrição de Exercício</h2>
            <div className="mt-4 flex flex-col">
              ...
              <textarea
                ...
                className="rounded-lg p-3 border border-gray-300 focus:ring focus:ring-blue-200 min-h-[150px]"
              ></textarea>
            </div>
          </div>
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-blue-900 border-b-2 border-blue-200 pb-2">Anexo de exames complementares</h2>
