                ...
                <table className="min-w-full">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    <tr>
                      ...
                      <td className="px-6 py-4"><input type="text" step="0.1" value={formData.forcaMaoDominante.medida1} onChange={(e) => handleStrengthChange("forcaMaoDominante", "medida1", e.target.value)} className="w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-blue-200" readOnly={somenteLeitura}/></td>
                      <td className="px-6 py-4"><input type="text" step="0.1" value={formData.forcaMaoDominante.medida2} onChange={(e) => handleStrengthChange("forcaMaoDominante", "medida2", e.target.value)} className="w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-blue-200" readOnly={somenteLeitura}/></td>
                      <td className="px-6 py-4"><input type="text" step="0.1" value={formData.forcaMaoDominante.medida3} onChange={(e) => handleStrengthChange("forcaMaoDominante", "medida3", e.target.value)} className="w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-blue-200" readOnly={somenteLeitura}/></td>
                    ...
                    <tr>
                      ...
                      <td className="px-6 py-4"><input type="text" step="0.1" value={formData.forcaMaoNaoDominante.medida1} onChange={(e) => handleStrengthChange("forcaMaoNaoDominante", "medida1", e.target.value)} className="w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-blue-200" readOnly={somenteLeitura} /></td>
                      <td className="px-6 py-4"><input type="text" step="0.1" value={formData.forcaMaoNaoDominante.medida2} onChange={(e) => handleStrengthChange("forcaMaoNaoDominante", "medida2", e.target.value)} className="w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-blue-200" readOnly={somenteLeitura} /></td>
                      <td className="px-6 py-4"><input type="text" step="0.1" value={formData.forcaMaoNaoDominante.medida3} onChange={(e) => handleStrengthChange("forcaMaoNaoDominante", "medida3", e.target.value)} className="w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-blue-200" readOnly={somenteLeitura} /></td>
                    ...
                    <tr>
                      ...
                      <td className="px-6 py-4"><input type="text" step="0.1" value={formData.forcaLombar.medida1} onChange={(e) => handleStrengthChange("forcaLombar", "medida1", e.target.value)} className="w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-blue-200" readOnly={somenteLeitura}  /></td>
                      <td className="px-6 py-4"><input type="text" step="0.1" value={formData.forcaLombar.medida2} onChange={(e) => handleStrengthChange("forcaLombar", "medida2", e.target.value)} className="w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-blue-200" readOnly={somenteLeitura}/></td>
                      <td className="px-6 py-4"><input type="text" step="0.1" value={formData.forcaLombar.medida3} onChange={(e) => handleStrengthChange("forcaLombar", "medida3", e.target.value)} className="w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-blue-200" readOnly={somenteLeitura}/></td>
